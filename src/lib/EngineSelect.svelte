<script lang="ts">
    import CustomEngineModal from "./CustomEngineModal.svelte";
    let isShowingSelectEngineModal = false
...
{#if isShowingSelectEngineModal}
<CustomEngineModal {setEngine} close={() => isShowingSelectEngineModal = false}/>
{/if}

<div class={isShowingSelectEngineModal?"hide":"content"}>
    <p>
    ...
    <button on:click={() => isShowingSelectEngineModal = true}>Custom</button>
</div>
